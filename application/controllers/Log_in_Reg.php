...
class Log_in_Reg extends CI_Controller {
	...
	public function reg()
	{
		...
		if($dob > time()) {
			$this->session->set_flashdata("errors", "You have to put a legit date of birth.");
			redirect('Log_in_Reg/index');
		}
	...
	public function login()
	{
		...
		if ($get_user)
		{
			$this->session->set_flashdata("success_message", "Welcome".$get_user['name']."! You have successfully logged in!");
